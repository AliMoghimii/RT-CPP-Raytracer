...
int main() {
    ...
    materials.push_back({ glm::vec3(0.9f, 0.95f, 1.0f), 0.05f, glm::vec3(0.0f), 1.0f, glm::vec3(0.0f), 1.0f, 0.05f, 0.5f, 1.31f, 1, 0, 1.0f, 0.0f, 1, 1, iceColor, iceNormal, iceRoughness, -1, iceDisp, 2.0f, 0.0f, 1.5f, 0.03f, 0.0f, 0.0f }); // Material 21: Ice (Tiled 2x)
